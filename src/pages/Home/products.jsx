...
const Products = () => {
  ...
  return (
    <>
      ...
      <div>
        <h2 className="text-3xl md:text-4xl items-center font-bold mb-8">
          <span className="border-t border-b border-[#EAD685] px-2">
            Products{" "}
          </span>
        </h2>

        <div className="bg-gradient-to-b from-blue-500 to-blue-700 py-12 px-6 text-white">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">
            {/* Left */}
            <div className="md:w-1/3">
              <p className="uppercase text-sm font-medium">Our Products</p>
              <h2 className="text-3xl font-bold my-4">Products you Can Buy</h2>
